...
class MapScreenState extends State<ProfilePage>
  ...
  void initState() {
    ...
    // int id = prefs.getInt("int")!; // Voltar para o login caso não exista
    // Response response = await dio.get('$baseUrl/users/$id'); // Pegar id do token salvo
    // Carregar os campos
  }
        ...
        showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                ...
                content: Text("Ocorreu um problema ao atualizar informações pessoais."),
                actions: [
                  TextButton(
                    child: Text("Ok"),
                    onPressed: () {
                              ...
                              children: <Widget>[
                                new Flexible(
                                  child: new DateTimePicker(
                                    ...
                                    onSaved: (birthDate) => _formData['birthDate'] = birthDate!,
                                  ),
                                ),
                              ],
                            )),
